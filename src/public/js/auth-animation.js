...
function showMouth(targetList, clipType) {
  ...
  // Outline: turn off when using Large group to avoid double-stroke
...
function initLoginForm() {
  ...
  // Enable original state: small + outline
  ...
  // Initialize mouth state - only show small mouth
